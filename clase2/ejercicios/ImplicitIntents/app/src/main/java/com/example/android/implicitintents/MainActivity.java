...
//        int1.setAction(Intent.ACTION_SEND);
//        int1.putExtra("pasaesto", txt);
//        int1.setType("text/plain");
//
//        Intent shareIntent = Intent.createChooser(int1, null);
//        shareIntent.putExtra(Intent.EXTRA_CHOOSER_TARGETS,"Implicit Intents Receiver");
//        startActivity(shareIntent);

//        Intent.createChooser(int1,null);s
