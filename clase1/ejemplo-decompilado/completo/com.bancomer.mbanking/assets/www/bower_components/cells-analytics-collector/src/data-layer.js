...
export default class DataLayer {
  ...
  updateBaseProperty(currentDataLayer, key, value) {
    const initialDataLayer = clone(this.data, true); // we clone the initial data.

    set(initialDataLayer, key, value);
    this.data = initialDataLayer;

    const dataLayerReferenceToUpdate = clone(currentDataLayer, true);

    set(dataLayerReferenceToUpdate, key, value);

    return dataLayerReferenceToUpdate;
  }
