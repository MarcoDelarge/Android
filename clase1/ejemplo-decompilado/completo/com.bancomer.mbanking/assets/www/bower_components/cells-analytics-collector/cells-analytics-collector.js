 ...
 */var CellsAnalyticsCollector=/*#__PURE__*/function(_Polymer$Element){babelHelpers.inherits(CellsAnalyticsCollector,_Polymer$Element);function CellsAnalyticsCollector(){babelHelpers.classCallCheck(this,CellsAnalyticsCollector);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(CellsAnalyticsCollector).apply(this,arguments))}babelHelpers.createClass(CellsAnalyticsCollector,null,[{key:"is",get:function get(){return"cells-analytics-collector"}}]);return CellsAnalyticsCollector}(Polymer.Element);window.customElements.define(CellsAnalyticsCollector.is,CellsAnalyticsCollector);