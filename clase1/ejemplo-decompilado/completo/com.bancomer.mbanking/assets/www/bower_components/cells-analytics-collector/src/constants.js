...
export var AUTO_CALCULATED_RESERVED_ANALYTICS_PROPERTIES=["page.pageInfo.pageName","page.pageInfo.server","user.device.userAgent","user.device.mobile"];export var ADOBE_PROVIDER_SCRIPT_SKELETON="//assets.adobedtm.com/";export var GOOGLE_PROVIDER_SCRIPT="https://www.google-analytics.com/analytics.js";export var DEFAULT_DATA_LAYER_NAME="digitalData";// Name of the data layer to expose in the window object
export var FULL_CHANNEL_VALUE_PATH="*";export var ANALYTICS_WORDS={PRIVATE:"privada",PUBLIC:"publica",YES:"si",NO:"no"};// Format taken from:
// https://drive.google.com/file/d/0B1LHjxcYuyz1ckJQMThpYTBqM1U/edit
export var DEFAULT_DATA_LAYER={versionDL:"1.10",pageInstanceID:"de",// 'de', 'pro', 'pre', 'qa', 'ei', 'aus'
...
productCode:"",quantity:""}]};export default{DEFAULT_DATA_LAYER:DEFAULT_DATA_LAYER,AUTO_CALCULATED_RESERVED_ANALYTICS_PROPERTIES:AUTO_CALCULATED_RESERVED_ANALYTICS_PROPERTIES,ANALYTICS_WORDS:ANALYTICS_WORDS,FULL_CHANNEL_VALUE_PATH:FULL_CHANNEL_VALUE_PATH,ADOBE_PROVIDER_SCRIPT_SKELETON:ADOBE_PROVIDER_SCRIPT_SKELETON,GOOGLE_PROVIDER_SCRIPT:GOOGLE_PROVIDER_SCRIPT,DEFAULT_DATA_LAYER_NAME:DEFAULT_DATA_LAYER_NAME};